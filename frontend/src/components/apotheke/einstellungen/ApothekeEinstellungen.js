...
function ApothekeEinstellungen(props) {
  ...
  const renderContent = () => {
    ...
    }/*else if( activeMenuItem==='btm' && btms) {
        //let filtered = filterBtms();
        //return <BtmListe {...props} updateBtmList={getBtmsData} user={user} btms={filtered} />;
    }else if(activeMenuItem==='aerzte' && aerzte) {
        //let filtered = filterAerzte();
        //return <ArztListe {...props} updateAerzteList={getAerzteData} user={user} aerzte={filtered} />
    }else if(activeMenuItem==='lieferanten' && lieferanten) {
        //let filtered = filterLieferanten();
        //return <LieferantListe {...props} updateLieferantenList={getLieferantenData} user={user} lieferanten={filtered} />
    }*/
  }
